...
{
    public partial class P_UsuarioAdd : Form
    {
        private int? Id;
        private P_Usuario Form;
        private P_FormPrincipal principal;
        public P_UsuarioAdd(P_Usuario Form, P_FormPrincipal principal, int? Id = null)//puede recibir o no un id
        {
            InitializeComponent();
            this.Form = Form;
            this.Id = Id;
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (N_Usuario.insertUsuario(getValueCampos()) > 0)
                {
                    this.Form.setDatosGrid();

                    this.Close();

                    this.principal.abrirForm(new P_Usuario(principal));
                }

            }
        }

        private E_Usuario getValueCampos()
        {
        ...
        private void P_UsuarioAdd_Load(object sender, EventArgs e)
        {
